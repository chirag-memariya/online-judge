...
<div className="relative overflow-x-auto shadow-md sm:rounded-lg bg-white dark:bg-gray-800 p-6">
  ...
  <div className="absolute top-0 right-0 w-96 h-96 bg-purple-300 dark:bg-purple-900 rounded-full filter blur-3xl opacity-20 animate-pulse z-0"></div>
  <div className="absolute bottom-0 left-0 w-96 h-96 bg-blue-300 dark:bg-blue-900 rounded-full filter blur-3xl opacity-20 animate-pulse z-0" style={{ animationDelay: '1s' }}></div>
  ...
  <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 relative z-10 overflow-x-auto p-5 mx-auto max-w-7xl sm:px-6 lg:px-8">
    ...
    <tbody>
      {submissions.length > 0 ? (
        ...
        <tr
          ...
          } border-b dark:border-gray-700 relative z-10`}
        >
